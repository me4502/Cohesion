...
void main() {
    ...
    if (slowed > 0.0) {
        gl_FragColor = vec4(gl_FragColor.xyz * 1.0 - 0.14 * rand(vec2(elapsedTime * tex.x / tex.y, tan(elapsedTime))), 1.0);
    }
}
