...
public class MapInstance {
	...
	public MapInstance(Color color) {
		...
		entities.add(player = new Player(this, new Sprite(Cohesion.instance.player), new Vector2d(50,100)));

		entities.add(new Platform(this, new Sprite(Cohesion.instance.platform), new Vector2d(50,50)));
	}
